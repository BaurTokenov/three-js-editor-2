import { ButtonInput, SliderInput, NumberInput, LabelElement, Element } from '../../libs/flow.module';
...
export class SliderEditor extends BaseNode {
  constructor() {
    ...
    this.add(new Element().add(field)).add(minElement).add(maxElement).add(moreElement);
