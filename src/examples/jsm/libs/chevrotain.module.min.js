...
var k = R((exports, module) => {
  ...
  var __spreadArray =
    ...
    function (t, e) {
      for (var r = 0, n = e.length, i = t.length; r < n; r++, i += 1) t[i] = e[r];
      return t;
    };
            ...
            n.config.skipValidations === !1 &&
              ...
              n.TRACE_INIT('performWarningRuntimeChecks', function () {
                n.lexerDefinitionWarning = n.lexerDefinitionWarning.concat(
                  Ee.performWarningRuntimeChecks(a, n.trackStartLines, n.config.lineTerminatorCharacters)
                );
              })),
...
` + i
      ...
      (t.prototype.TRACE_INIT = function (e, r) {
        if (this.traceInitPerf === !0) {
          ...
          return (
            this.traceInitIndent < this.traceInitMaxIdent && s(n + '<-- <' + e + '> time: ' + a + 'ms'),
            this.traceInitIndent--,
            o
          );
        } else return r();
...
var Tt = R((j) => {
  ...
  var Et = (function (t) {
    ...
    function e(r, n) {
      var i = t.call(this) || this;
      return (
        (i.topRule = r), (i.occurrence = n), (i.result = { token: void 0, occurrence: void 0, isEndOfRule: void 0 }), i
      );
    }
    return (
      (e.prototype.startWalking = function () {
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`
        ...
        (t.prototype.atLeastOneInternalLogic = function (e, r, n) {
          ...
          if (a.call(this) === !0)
            for (var f = this.doSingleRepetition(o); a.call(this) === !0 && f === !0; ) f = this.doSingleRepetition(o);
