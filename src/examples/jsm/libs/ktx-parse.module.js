...
class c {
  ...
  _scan(t, e = 0) {
    ...
    let i = 0;
    for (; this._dataView.getUint8(this._offset) !== e && i < t; ) (i += 1), this._offset++;
...
export {
  l as KTX2ChannelETC1S,
  f as KTX2ChannelUASTC,
  U as KTX2Container,
  i as KTX2DescriptorType,
  o as KTX2Flags,
  s as KTX2Model,
  a as KTX2Primaries,
  n as KTX2SupercompressionScheme,
  r as KTX2Transfer,
  p as read,
  y as write,
};
