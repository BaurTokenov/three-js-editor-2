...
import { UIDiv, UIRow, UIText, UIInteger, UICheckbox, UIButton, UINumber } from './libs/ui';
...
function GeometryParametersPanel(editor, object) {
  ...
  function toShape() {
    editor.execute(
      new SetGeometryCommand(editor, object, new THREE.ShapeGeometry(parameters.shapes, options.curveSegments))
    );
  }
