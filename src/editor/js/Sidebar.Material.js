...
import { UIButton, UIInput, UIPanel, UIRow, UISelect, UIText, UITextArea } from './libs/ui';
...
function SidebarMaterial(editor) {
  ...
  const materialName = new UIInput()
    ...
    .onChange(function () {
      editor.execute(
        new SetMaterialValueCommand(editor, editor.selected, 'name', materialName.getValue(), currentMaterialSlot)
      );
    });
  ...
  function update() {
    ...
    if (material) {
      if (material.uuid !== undefined && material.uuid !== materialUUID.getValue()) {
        editor.execute(
          new SetMaterialValueCommand(editor, currentObject, 'uuid', materialUUID.getValue(), currentMaterialSlot)
        );
      }
