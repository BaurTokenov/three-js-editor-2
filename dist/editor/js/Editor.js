...
function Editor() {
    ...
    this.strings = new Strings_1.Strings(this.config);
...
Editor.prototype = {
    ...
    addMaterial: function (material) {
        if (Array.isArray(material)) {
            for (var i = 0, l = material.length; i < l; i += 1) {
    ...
    fromJSON: function (json) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var camera = yield loader.parseAsync(json.camera);
            this.camera.copy(camera);
            this.signals.cameraResetted.dispatch();
            this.history.fromJSON(json.history);
            this.scripts = json.scripts;
            this.setScene(yield loader.parseAsync(json.scene));
        });
    },
    toJSON: function () {
        // scripts clean up
