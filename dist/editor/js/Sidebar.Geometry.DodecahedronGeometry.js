...
function GeometryParametersPanel(editor, object) {
    ...
    radiusRow.add(new ui_1.UIText(strings.getKey('sidebar/geometry/dodecahedron_geometry/radius')).setWidth('90px'));
    ...
    detailRow.add(new ui_1.UIText(strings.getKey('sidebar/geometry/dodecahedron_geometry/detail')).setWidth('90px'));
    detailRow.add(detail);
    container.add(detailRow);
    //
    function update() {
        editor.execute(new SetGeometryCommand_1.SetGeometryCommand(editor, object, new THREE.DodecahedronGeometry(radius.getValue(), detail.getValue())));
    }
    return container;
}
