        ...
        3: [
            function (require, module, exports) {
                ...
                lp.toAssignableList = function (exprList) {
                    for (var i = 0; i < exprList.length; i += 1) {
            ...
            function (require, module, exports) {
                ...
                lp.parseClass = function (isStatement) {
                    ...
                    while (!this.closes(tt.braceR, indent, line)) {
                        if (this.semicolon())
                            continue;
                        var method = this.startNode(), isGenerator = undefined, start = undefined;
                        if (this.options.ecmaVersion >= 6) {
                            method['static'] = false;
                            isGenerator = this.eat(tt.star);
                        }
                        ...
                        try {
                            ...
                            if (/unterminated/i.test(msg)) {
                                ...
                                if (/string/.test(msg)) {
                                    ...
                                    replace = { start: e.pos, end: pos, type: tt.template, value: this.input.slice(e.pos, pos) };
                                }
                                else {
                                    replace = false;
                                }
