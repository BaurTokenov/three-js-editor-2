...
class ColladaExporter {
    parse(object, onDone, options = {}) {
        ...
        function getTransform(o) {
            ...
            o.updateMatrix();
            transMat = transMat || new three_1.Matrix4();
        ...
        function processGeometry(g) {
            ...
            if (!info) {
                ...
                const groups = bufferGeometry.groups != null && bufferGeometry.groups.length !== 0 ?
        ...
        function processMaterial(m) {
            ...
            if (matid == null) {
                ...
                const emissive = m.emissive ? m.emissive : new three_1.Color(0, 0, 0);
                const diffuse = m.color ? m.color : new three_1.Color(0, 0, 0);
                const specular = m.specular ? m.specular : new three_1.Color(1, 1, 1);
                ...
                const techniqueNode = `<technique sid="common"><${type}>` +
                    ...
                    transparencyNode +
                    `</${type}></technique>`;
                const effectnode = `<effect id="${matid}-effect">` +
                    '<profile_COMMON>' +
                    (m.map ?
        ...
        function processObject(o) {
            ...
            if (o.isMesh === true && o.geometry !== null) {
                ...
                // the materials.
                const mat = o.material || new three_1.MeshBasicMaterial();
        ...
        let dae = '<?xml version="1.0" encoding="UTF-8" standalone="no" ?>' +
