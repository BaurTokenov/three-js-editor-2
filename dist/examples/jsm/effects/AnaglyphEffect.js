...
class AnaglyphEffect {
    constructor(renderer, width = 512, height = 512) {
        ...
        this.colorMatrixLeft = new three_1.Matrix3().fromArray([
            0.456100, -0.0400822, -0.0152161,
            0.500484, -0.0378246, -0.0205971,
            0.176381, -0.0157589, -0.00546856
        ]);
        this.colorMatrixRight = new three_1.Matrix3().fromArray([
        ...
        const _renderTargetL = new three_1.WebGLRenderTarget(width, height, _params);
        const _renderTargetR = new three_1.WebGLRenderTarget(width, height, _params);
        ...
        const _mesh = new three_1.Mesh(new three_1.PlaneGeometry(2, 2), _material);
        _scene.add(_mesh);
