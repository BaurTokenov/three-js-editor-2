...
exports.DecoratedTorusKnot5c = exports.DecoratedTorusKnot5a = exports.DecoratedTorusKnot4b = exports.DecoratedTorusKnot4a = exports.FigureEightPolynomialKnot = exports.TrefoilPolynomialKnot = exports.CinquefoilKnot = exports.TorusKnot = exports.TrefoilKnot = exports.HelixCurve = exports.KnotCurve = exports.VivianiCurve = exports.HeartCurve = exports.GrannyKnot = void 0;
 ...
 */
// GrannyKnot
class GrannyKnot extends three_1.Curve {
...
// HeartCurve
class HeartCurve extends three_1.Curve {
    constructor(scale = 5) {
        super();
        this.scale = scale;
    }
...
// Viviani's Curve
class VivianiCurve extends three_1.Curve {
...
// KnotCurve
class KnotCurve extends three_1.Curve {
    getPoint(t, optionalTarget = new three_1.Vector3()) {
        const point = optionalTarget;
        t *= 2 * Math.PI;
        const R = 10;
...
// HelixCurve
class HelixCurve extends three_1.Curve {
    getPoint(t, optionalTarget = new three_1.Vector3()) {
        const point = optionalTarget;
        const a = 30; // radius
        const b = 150; // height
...
// TrefoilKnot
class TrefoilKnot extends three_1.Curve {
...
// TorusKnot
class TorusKnot extends three_1.Curve {
    constructor(scale = 10) {
        super();
        this.scale = scale;
    }
...
// CinquefoilKnot
class CinquefoilKnot extends three_1.Curve {
    constructor(scale = 10) {
        super();
        this.scale = scale;
    }
...
class TrefoilPolynomialKnot extends three_1.Curve {
    constructor(scale = 10) {
        super();
        this.scale = scale;
    }
...
class FigureEightPolynomialKnot extends three_1.Curve {
    constructor(scale = 1) {
        super();
        this.scale = scale;
    }
...
class DecoratedTorusKnot4a extends three_1.Curve {
...
class DecoratedTorusKnot4b extends three_1.Curve {
    constructor(scale = 40) {
        super();
        this.scale = scale;
    }
...
class DecoratedTorusKnot5a extends three_1.Curve {
    constructor(scale = 40) {
        super();
        this.scale = scale;
    }
...
class DecoratedTorusKnot5c extends three_1.Curve {
    constructor(scale = 40) {
        super();
        this.scale = scale;
    }
