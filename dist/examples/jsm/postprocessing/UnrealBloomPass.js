...
const LuminosityHighPassShader_1 = require("../shaders/LuminosityHighPassShader");
/**
...
class UnrealBloomPass extends Pass_1.Pass {
    constructor(resolution, strength, radius, threshold) {
        ...
        if (LuminosityHighPassShader_1.LuminosityHighPassShader === undefined)
            console.error('THREE.UnrealBloomPass relies on LuminosityHighPassShader');
        const highPassShader = LuminosityHighPassShader_1.LuminosityHighPassShader;
