...
const ShaderPass_1 = require("./ShaderPass");
const MaskPass_1 = require("./MaskPass");
const MaskPass_2 = require("./MaskPass");
class EffectComposer {
    constructor(renderer, renderTarget) {
        ...
        if (ShaderPass_1.ShaderPass === undefined) {
            console.error('THREE.EffectComposer relies on ShaderPass');
        }
        this.copyPass = new ShaderPass_1.ShaderPass(CopyShader_1.CopyShader);
    ...
    render(deltaTime) {
        ...
        for (let i = 0, il = this.passes.length; i < il; i += 1) {
            ...
            if (MaskPass_1.MaskPass !== undefined) {
                if (pass instanceof MaskPass_1.MaskPass) {
                    maskActive = true;
                }
                else if (pass instanceof MaskPass_2.ClearMaskPass) {
                    maskActive = false;
                }
            }
        }
