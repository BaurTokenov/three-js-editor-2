 ...
 *
 */
class TeapotGeometry extends three_1.BufferGeometry {
    constructor(size = 50, segments = 10, bottom = true, lid = true, body = true, fitLid = true, blinn = true) {
        ...
        const sdir = [];
        const tdir = [];
        const norm = new three_1.Vector3();
        let tcoord;
        let sval;
        let tval;
        let p;
        let dsval = 0;
        let dtval = 0;
        const normOut = new three_1.Vector3();
        const gmx = new three_1.Matrix4();
        const tmtx = new three_1.Matrix4();
        const vsp = new three_1.Vector4();
        const vtp = new three_1.Vector4();
        const vdsp = new three_1.Vector4();
        const vdtp = new three_1.Vector4();
        const vsdir = new three_1.Vector3();
        const vtdir = new three_1.Vector3();
        const mst = ms.clone();
        mst.transpose();
        ...
        this.setIndex(new three_1.BufferAttribute(indices, 1));
        this.setAttribute('position', new three_1.BufferAttribute(vertices, 3));
        this.setAttribute('normal', new three_1.BufferAttribute(normals, 3));
