 ...
 *
 */
class LightningStrike extends three_1.BufferGeometry {
    ...
    static copyParameters(dest = {}, source = {}) {
        ...
        (dest.sourceOffset = source.sourceOffset !== undefined ? vecCopy(source.sourceOffset) : new three_1.Vector3(0, 100, 0)),
            (dest.destOffset = source.destOffset !== undefined ? vecCopy(source.destOffset) : new three_1.Vector3(0, 0, 0)),
            ...
            (dest.up0 = source.up0 !== undefined ? vecCopy(source.up0) : new three_1.Vector3(0, 0, 1));
        (dest.up1 = source.up1 !== undefined ? vecCopy(source.up1) : new three_1.Vector3(0, 0, 1)),
    ...
    init(rayParameters) {
        ...
        this.subrays = [];
        for (let i = 0; i < this.maxSubrays; i += 1) {
            this.subrays.push(this.createSubray());
        }
        this.raySegments = [];
        for (let i = 0; i < this.maxRaySegments; i += 1) {
        ...
        this.simplexX = new SimplexNoise_1.SimplexNoise(this.seedGenerator);
        this.simplexY = new SimplexNoise_1.SimplexNoise(this.seedGenerator);
        this.simplexZ = new SimplexNoise_1.SimplexNoise(this.seedGenerator);
        // Temp vectors
        this.forwards = new three_1.Vector3();
        this.forwardsFill = new three_1.Vector3();
        this.side = new three_1.Vector3();
        this.down = new three_1.Vector3();
        this.middlePos = new three_1.Vector3();
        this.middleLinPos = new three_1.Vector3();
        this.newPos = new three_1.Vector3();
        this.vPos = new three_1.Vector3();
        this.cross1 = new three_1.Vector3();
    }
    createMesh() {
    ...
    createDefaultSubrayCreationCallbacks() {
        ...
        this.onDecideSubrayCreation = function (segment, lightningStrike) {
            ...
            const phase0 = lightningStrike.rayParameters.isEternal && subray.recursion == 0
                ? -random1() * period
                : three_1.MathUtils.lerp(subray.birthTime, subray.endPropagationTime, segment.fraction0) - random1() * period;
        ...
        const vec1Pos = new three_1.Vector3();
        const vec2Forward = new three_1.Vector3();
        const vec3Side = new three_1.Vector3();
        const vec4Up = new three_1.Vector3();
    ...
    createSubray() {
        return {
            ...
            maxIterations: 0,
            recursion: 0,
            pos0: new three_1.Vector3(),
            pos1: new three_1.Vector3(),
            linPos0: new three_1.Vector3(),
            linPos1: new three_1.Vector3(),
            up0: new three_1.Vector3(),
            up1: new three_1.Vector3(),
            radius0: 0,
            radius1: 0,
            birthTime: 0,
            deathTime: 0,
