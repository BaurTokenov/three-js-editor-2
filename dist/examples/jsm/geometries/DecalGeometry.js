 ...
 *
 */
class DecalGeometry extends three_1.BufferGeometry {
    constructor(mesh, position, orientation, size) {
        ...
        const uvs = [];
        // helpers
        const plane = new three_1.Vector3();
        // this matrix represents the transformation of the decal projector
        const projectorMatrix = new three_1.Matrix4();
        projectorMatrix.makeRotationFromEuler(orientation);
        projectorMatrix.setPosition(position);
        const projectorMatrixInverse = new three_1.Matrix4();
        ...
        function clip(v0, v1, p, s) {
            ...
            const s0 = d0 / (d0 - d1);
            const v = new DecalVertex(new three_1.Vector3(v0.position.x + s0 * (v1.position.x - v0.position.x), v0.position.y + s0 * (v1.position.y - v0.position.y), v0.position.z + s0 * (v1.position.z - v0.position.z)), new three_1.Vector3(v0.normal.x + s0 * (v1.normal.x - v0.normal.x), v0.normal.y + s0 * (v1.normal.y - v0.normal.y), v0.normal.z + s0 * (v1.normal.z - v0.normal.z)));
