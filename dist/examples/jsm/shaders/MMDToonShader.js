...
const MMDToonShader = {
    ...
    uniforms: three_1.UniformsUtils.merge([
        three_1.ShaderLib.toon.uniforms,
        three_1.ShaderLib.phong.uniforms,
        three_1.ShaderLib.matcap.uniforms,
    ]),
    vertexShader: three_1.ShaderLib.phong.vertexShader,
    fragmentShader: three_1.ShaderLib.phong.fragmentShader
