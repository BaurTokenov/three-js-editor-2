...
class TessellateModifier {
    ...
    modify(geometry) {
        ...
        const vm = new three_1.Vector3();
        const vs = [va, vb, vc, vm];
        const na = new three_1.Vector3();
        const nb = new three_1.Vector3();
        const nc = new three_1.Vector3();
        const nm = new three_1.Vector3();
        const ns = [na, nb, nc, nm];
        const ca = new three_1.Color();
        const cb = new three_1.Color();
        const cc = new three_1.Color();
        const cm = new three_1.Color();
        const cs = [ca, cb, cc, cm];
        const ua = new three_1.Vector2();
        const ub = new three_1.Vector2();
        const uc = new three_1.Vector2();
        const um = new three_1.Vector2();
        const us = [ua, ub, uc, um];
        const u2a = new three_1.Vector2();
        const u2b = new three_1.Vector2();
        const u2c = new three_1.Vector2();
        const u2m = new three_1.Vector2();
        ...
        if (hasNormals) {
            geometry2.setAttribute('normal', new three_1.Float32BufferAttribute(normals2, 3));
        }
        if (hasColors) {
            geometry2.setAttribute('color', new three_1.Float32BufferAttribute(colors2, 3));
        }
        if (hasUVs) {
            geometry2.setAttribute('uv', new three_1.Float32BufferAttribute(uvs2, 2));
        }
        if (hasUV2s) {
            geometry2.setAttribute('uv2', new three_1.Float32BufferAttribute(uv2s2, 2));
        }
        return geometry2;
    }
}
