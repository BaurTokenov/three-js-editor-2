...
const _start4 = new three_1.Vector4();
const _end4 = new three_1.Vector4();
const _ssOrigin = new three_1.Vector4();
const _ssOrigin3 = new three_1.Vector3();
const _mvMatrix = new three_1.Matrix4();
const _line = new three_1.Line3();
const _closestPoint = new three_1.Vector3();
const _box = new three_1.Box3();
const _sphere = new three_1.Sphere();
const _clipToWorldVector = new three_1.Vector4();
...
function raycastWorldUnits(lineSegments, intersects) {
    for (let i = 0, l = _instanceStart.count; i < l; i += 1) {
        _line.start.fromBufferAttribute(_instanceStart, i);
        _line.end.fromBufferAttribute(_instanceEnd, i);
        const pointOnLine = new three_1.Vector3();
...
function raycastScreenSpace(lineSegments, camera, intersects) {
    ...
    for (let i = 0, l = instanceStart.count; i < l; i += 1) {
        ...
        const zPos = three_1.MathUtils.lerp(_start4.z, _end4.z, param);
...
class LineSegments2 extends three_1.Mesh {
