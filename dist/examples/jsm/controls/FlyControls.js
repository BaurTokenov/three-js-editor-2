...
class FlyControls extends three_1.EventDispatcher {
    constructor(object, domElement) {
        ...
        this.tmpQuaternion = new three_1.Quaternion();
        this.mouseStatus = 0;
        this.moveState = { up: 0, down: 0, left: 0, right: 0, forward: 0, back: 0, pitchUp: 0, pitchDown: 0, yawLeft: 0, yawRight: 0, rollLeft: 0, rollRight: 0 };
        this.moveVector = new three_1.Vector3(0, 0, 0);
        this.rotationVector = new three_1.Vector3(0, 0, 0);
