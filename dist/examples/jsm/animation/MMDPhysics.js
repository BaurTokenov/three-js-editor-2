...
class MMDPhysics {
    ...
    constructor(mesh, rigidBodyParams, constraintParams = [], params = {}) {
        ...
        this.gravity = new three_1.Vector3(0, -9.8 * 10, 0);
...
const _matrixWorldInv = new three_1.Matrix4();
class MMDPhysicsHelper extends three_1.Object3D {
    /**
    ...
    constructor(mesh, physics) {
        ...
        this.materials = [];
        this.materials.push(new three_1.MeshBasicMaterial({
    ...
    _init() {
        ...
        function createGeometry(param) {
            switch (param.shapeType) {
                case 0:
                    return new three_1.SphereGeometry(param.width, 16, 8);
                case 1:
                    return new three_1.BoxGeometry(param.width * 2, param.height * 2, param.depth * 2, 8, 8, 8);
                case 2:
        ...
        function createCapsuleGeometry(radius, cylinderHeight, segmentsRadius, segmentsHeight) {
            var geometry = new three_1.CylinderGeometry(radius, radius, cylinderHeight, segmentsRadius, segmentsHeight, true);
            var upperSphere = new three_1.Mesh(new three_1.SphereGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, 0, Math.PI / 2));
            var lowerSphere = new three_1.Mesh(new three_1.SphereGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, Math.PI / 2, Math.PI / 2));
        ...
        for (var i = 0, il = bodies.length; i < il; i++) {
            ...
            this.add(new three_1.Mesh(createGeometry(param), this.materials[param.type]));
        }
    }
}
