...
const _va = /*@__PURE__*/ new three_1.Vector3(), // from pe to pa
_vb = /*@__PURE__*/ new three_1.Vector3(), // from pe to pb
_vc = /*@__PURE__*/ new three_1.Vector3(), // from pe to pc
_vr = /*@__PURE__*/ new three_1.Vector3(), // right axis of screen
_vu = /*@__PURE__*/ new three_1.Vector3(), // up axis of screen
_vn = /*@__PURE__*/ new three_1.Vector3(), // normal vector of screen
_vec = /*@__PURE__*/ new three_1.Vector3(), // temporary vector
_quat = /*@__PURE__*/ new three_1.Quaternion(); // temporary quaternion
...
function frameCorners(camera, bottomLeftCorner, bottomRightCorner, topLeftCorner, estimateViewFrustum = false) {
    ...
    if (estimateViewFrustum) {
        ...
        camera.fov =
            three_1.MathUtils.RAD2DEG / Math.min(1.0, camera.aspect) *
