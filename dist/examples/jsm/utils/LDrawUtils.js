...
class LDrawUtils {
    static mergeObject(object) {
        ...
        function extractGroup(geometry, group, elementSize, isConditionalLine) {
            ...
            newGeometry.setAttribute('position', new three_1.BufferAttribute(positions, 3));
            if (normals !== null)
                newGeometry.setAttribute('normal', new three_1.BufferAttribute(normals, 3));
            if (isConditionalLine) {
                ...
                newGeometry.setAttribute('control0', new three_1.BufferAttribute(controlArray0, 3, false));
                newGeometry.setAttribute('control1', new three_1.BufferAttribute(controlArray1, 3, false));
                newGeometry.setAttribute('direction', new three_1.BufferAttribute(directionArray, 3, false));
            }
            return newGeometry;
        }
        ...
        const mergedObject = new three_1.Group();
        ...
        for (const meshMaterialsId of meshMaterialsIds) {
            ...
            const mergedGeometry = BufferGeometryUtils_1.mergeBufferGeometries(meshGeometry.arr);
            mergedObject.add(new three_1.Mesh(mergedGeometry, meshGeometry.mat));
        }
        ...
        for (const linesMaterialsId of linesMaterialsIds) {
            ...
            const mergedGeometry = BufferGeometryUtils_1.mergeBufferGeometries(lineGeometry.arr);
            mergedObject.add(new three_1.LineSegments(mergedGeometry, lineGeometry.mat));
        }
        ...
        for (const condLinesMaterialsId of condLinesMaterialsIds) {
            ...
            const mergedGeometry = BufferGeometryUtils_1.mergeBufferGeometries(condLineGeometry.arr);
            const condLines = new three_1.LineSegments(mergedGeometry, condLineGeometry.mat);
