...
class MorphBlendMesh extends three_1.Mesh {
    ...
    update(delta) {
        for (let i = 0, il = this.animationsList.length; i < il; i++) {
            ...
            const keyframe = animation.start + three_1.MathUtils.clamp(Math.floor(animation.time / frameTime), 0, animation.length - 1);
