...
const VolumeSlice_1 = require("../misc/VolumeSlice");
/**
...
function Volume(xLength, yLength, zLength, type, arrayBuffer) {
     ...
     */
    this.matrix = new three_1.Matrix3();
...
Volume.prototype = {
    ...
    extractPerpendicularPlane: function (axis, RASIndex) {
        ...
        const axisInIJK = new three_1.Vector3(), firstDirection = new three_1.Vector3(), secondDirection = new three_1.Vector3(), planeMatrix = new three_1.Matrix4().identity(), volume = this;
        const dimensions = new three_1.Vector3(this.xLength, this.yLength, this.zLength);
        switch (axis) {
            case 'x':
                axisInIJK.set(1, 0, 0);
                ...
                IJKIndex = new three_1.Vector3(RASIndex, 0, 0);
                planeMatrix.multiply(new three_1.Matrix4().makeRotationY(Math.PI / 2));
                positionOffset = (volume.RASDimensions[0] - 1) / 2;
                planeMatrix.setPosition(new three_1.Vector3(RASIndex - positionOffset, 0, 0));
                break;
            case 'y':
                axisInIJK.set(0, 1, 0);
                ...
                IJKIndex = new three_1.Vector3(0, RASIndex, 0);
                planeMatrix.multiply(new three_1.Matrix4().makeRotationX(-Math.PI / 2));
                positionOffset = (volume.RASDimensions[1] - 1) / 2;
                planeMatrix.setPosition(new three_1.Vector3(0, RASIndex - positionOffset, 0));
                break;
            case 'z':
            default:
                axisInIJK.set(0, 0, 1);
                ...
                firstSpacing = this.spacing[this.axisOrder.indexOf('x')];
                secondSpacing = this.spacing[this.axisOrder.indexOf('y')];
                IJKIndex = new three_1.Vector3(0, 0, RASIndex);
                positionOffset = (volume.RASDimensions[2] - 1) / 2;
                planeMatrix.setPosition(new three_1.Vector3(0, 0, RASIndex - positionOffset));
                break;
        }
        ...
        const base = [new three_1.Vector3(1, 0, 0), new three_1.Vector3(0, 1, 0), new three_1.Vector3(0, 0, 1)];
    ...
    extractSlice: function (axis, index) {
        const slice = new VolumeSlice_1.VolumeSlice(this, index, axis);
