...
const _normalMatrix = new three_1.Matrix3();
class VertexNormalsHelper extends three_1.LineSegments {
    constructor(object, size = 1, color = 0xff0000) {
        const geometry = new three_1.BufferGeometry();
        const nNormals = object.geometry.attributes.normal.count;
        const positions = new three_1.Float32BufferAttribute(nNormals * 2 * 3, 3);
