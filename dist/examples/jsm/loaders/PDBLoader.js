...
class PDBLoader extends three_1.Loader {
    constructor(manager) {
        super(manager);
    }
    ...
    parse(text) {
        ...
        function buildGeometry() {
            const build = {
                geometryAtoms: new three_1.BufferGeometry(),
                geometryBonds: new three_1.BufferGeometry(),
                json: {
                    atoms: atoms
                }
            };
            ...
            // build geometry
            geometryAtoms.setAttribute('position', new three_1.Float32BufferAttribute(verticesAtoms, 3));
            geometryAtoms.setAttribute('color', new three_1.Float32BufferAttribute(colorsAtoms, 3));
            geometryBonds.setAttribute('position', new three_1.Float32BufferAttribute(verticesBonds, 3));
            return build;
        }
