...
class MD2Loader extends three_1.Loader {
    constructor(manager) {
        super(manager);
    }
    ...
    parse(buffer) {
        ...
        // frames
        const translation = new three_1.Vector3();
        ...
        for (let i = 0, l = frames.length; i < l; i++) {
            ...
            if (frame.vertices.length > 0) {
                ...
                const positionAttribute = new three_1.Float32BufferAttribute(positions, 3);
            ...
            if (frame.normals.length > 0) {
                ...
                const normalAttribute = new three_1.Float32BufferAttribute(normals, 3);
        ...
        geometry.animations = three_1.AnimationClip.CreateClipsFromMorphTargetSequences(frames, 10);
        return geometry;
    }
}
