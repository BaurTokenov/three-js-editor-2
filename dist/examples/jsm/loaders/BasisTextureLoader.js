...
class BasisTextureLoader extends three_1.Loader {
    constructor(manager) {
        super(manager);
        this.transcoderPath = '';
        ...
        console.warn('THREE.BasisTextureLoader: This loader is deprecated, and will be removed in a future release. '
    ...
    parseInternalAsync(options) {
        ...
        return this._createTexture(Array.from(buffers), Object.assign(Object.assign({}, options), { lowLevel: true }));
    }
    /**
