...
class DRACOLoader extends three_1.Loader {
    constructor(manager) {
        super(manager);
        this.decoderPath = '';
        this.decoderConfig = {};
    ...
    _createGeometry(geometryData) {
        ...
        if (geometryData.index) {
            geometry.setIndex(new three_1.BufferAttribute(geometryData.index.array, 1));
        }
        for (let i = 0; i < geometryData.attributes.length; i++) {
            ...
            geometry.setAttribute(name, new three_1.BufferAttribute(array, itemSize));
        }
        return geometry;
    }
