 ...
 *
 *  for (let i = 0; i < nGeometryGroups; i += 1) {
 *
 ...
 */
class STLLoader extends three_1.Loader {
    constructor(manager) {
        super(manager);
    }
    ...
    parse(data) {
        ...
        function parseBinary(data) {
            ...
            if (hasColors) {
                geometry.setAttribute('color', new three_1.BufferAttribute(colors, 3));
        ...
        function ensureString(buffer) {
            if (typeof buffer !== 'string') {
                return three_1.LoaderUtils.decodeText(new Uint8Array(buffer));
            }
            return buffer;
        }
