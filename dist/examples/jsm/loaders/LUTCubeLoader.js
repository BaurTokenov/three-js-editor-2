...
class LUTCubeLoader extends three_1.Loader {
    ...
    parse(str) {
        ...
        let title = null;
        let size = null;
        const domainMin = new three_1.Vector3(0, 0, 0);
        const domainMax = new three_1.Vector3(1, 1, 1);
        ...
        texture3D.type = three_1.UnsignedByteType;
        texture3D.magFilter = three_1.LinearFilter;
        texture3D.minFilter = three_1.LinearFilter;
        texture3D.wrapS = three_1.ClampToEdgeWrapping;
        texture3D.wrapT = three_1.ClampToEdgeWrapping;
        texture3D.wrapR = three_1.ClampToEdgeWrapping;
