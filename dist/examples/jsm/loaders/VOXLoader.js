...
exports.VOXMesh = exports.VOXLoader = void 0;
const three_1 = require("three");
class VOXLoader extends three_1.Loader {
    ...
    parse(buffer) {
        ...
        while (i < data.byteLength) {
            let id = '';
            for (let j = 0; j < 4; j++) {
                id += String.fromCharCode(data.getUint8((i += 1)));
            }
...
class VOXMesh extends three_1.Mesh {
    constructor(chunk) {
