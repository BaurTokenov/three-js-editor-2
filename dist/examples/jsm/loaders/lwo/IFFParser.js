...
exports.IFFParser = void 0;
const three_1 = require("three");
const LWO2Parser_1 = require("./LWO2Parser");
const LWO3Parser_1 = require("./LWO3Parser");
function IFFParser() {
...
IFFParser.prototype = {
    ...
    parse: function (buffer) {
        ...
        if (this.tree.format === 'LWO2') {
            this.parser = new LWO2Parser_1.LWO2Parser(this);
            while (!this.reader.endOfFile())
                this.parser.parseBlock();
        }
        else if (this.tree.format === 'LWO3') {
            this.parser = new LWO3Parser_1.LWO3Parser(this);
            while (!this.reader.endOfFile())
                this.parser.parseBlock();
        }
...
Debugger.prototype = {
    ...
    closeForms: function () {
        if (!this.active)
            return;
        for (var i = this.formList.length - 1; i >= 0; i -= 1) {
...
function printBuffer(buffer, from, to) {
    console.log(three_1.LoaderUtils.decodeText(new Uint8Array(buffer, from, to)));
}
