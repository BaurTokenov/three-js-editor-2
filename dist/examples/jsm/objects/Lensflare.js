...
class Lensflare extends three_1.Mesh {
    constructor() {
        super(Lensflare.Geometry, new three_1.MeshBasicMaterial({ opacity: 0, transparent: true }));
        this.type = 'Lensflare';
        ...
        const material1b = new three_1.RawShaderMaterial({
            uniforms: {
                'map': { value: tempMap },
                'scale': { value: null },
                'screenPosition': { value: null }
        ...
        const mesh1 = new three_1.Mesh(geometry, material1a);
        //
        const elements = [];
        const shader = LensflareElement.Shader;
        const material2 = new three_1.RawShaderMaterial({
            uniforms: {
                'map': { value: null },
                'occlusionMap': { value: occlusionMap },
                'color': { value: new three_1.Color(0xffffff) },
                'scale': { value: new three_1.Vector2() },
                'screenPosition': { value: new three_1.Vector3() }
            },
        ...
        const mesh2 = new three_1.Mesh(geometry, material2);
...
class LensflareElement {
    constructor(texture, size = 1, distance = 0, color = new three_1.Color(0xffffff)) {
