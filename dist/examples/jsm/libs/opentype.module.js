...
exports.parse = exports.loadSync = exports.load = exports._parse = exports.Path = exports.Glyph = exports.Font = exports.BoundingBox = void 0;
...
var eightBitMacEncodings = {
    // Python: 'mac_croatian'
    'x-mac-croatian': 'ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®Š™´¨≠ŽØ∞±≤≥∆µ∂∑∏š∫ªºΩžø' +
        '¿¡¬√ƒ≈Ć«Č… ÀÃÕŒœĐ—“”‘’÷◊©⁄€‹›Æ»–·‚„‰ÂćÁčÈÍÎÏÌÓÔđÒÚÛÙıˆ˜¯πË˚¸Êæˇ',
    // Python: 'mac_cyrillic'
    'x-mac-cyrillic': 'АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ†°Ґ£§•¶І®©™Ђђ≠Ѓѓ∞±≤≥іµґЈЄєЇїЉљЊњ' +
        'јЅ¬√ƒ≈∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёяабвгдежзийклмнопрстуфхцчшщъыьэю',
    // http://unicode.org/Public/MAPPINGS/VENDORS/APPLE/GAELIC.TXT
    'x-mac-gaelic': 'ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØḂ±≤≥ḃĊċḊḋḞḟĠġṀæø' +
        'ṁṖṗɼƒſṠ«»… ÀÃÕŒœ–—“”‘’ṡẛÿŸṪ€‹›Ŷŷṫ·Ỳỳ⁊ÂÊÁËÈÍÎÏÌÓÔ♣ÒÚÛÙıÝýŴŵẄẅẀẁẂẃ',
    // Python: 'mac_greek'
    'x-mac-greek': 'Ä¹²É³ÖÜ΅àâä΄¨çéèêë£™îï•½‰ôö¦€ùûü†ΓΔΘΛΞΠß®©ΣΪ§≠°·Α±≤≥¥ΒΕΖΗΙΚΜΦΫΨΩ' +
        'άΝ¬ΟΡ≈Τ«»… ΥΧΆΈœ–―“”‘’÷ΉΊΌΎέήίόΏύαβψδεφγηιξκλμνοπώρστθωςχυζϊϋΐΰ\u00AD',
    // Python: 'mac_iceland'
    'x-mac-icelandic': 'ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûüÝ°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø' +
        '¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄€ÐðÞþý·‚„‰ÂÊÁËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ',
    // http://unicode.org/Public/MAPPINGS/VENDORS/APPLE/INUIT.TXT
    'x-mac-inuit': 'ᐃᐄᐅᐆᐊᐋᐱᐲᐳᐴᐸᐹᑉᑎᑏᑐᑑᑕᑖᑦᑭᑮᑯᑰᑲᑳᒃᒋᒌᒍᒎᒐᒑ°ᒡᒥᒦ•¶ᒧ®©™ᒨᒪᒫᒻᓂᓃᓄᓅᓇᓈᓐᓯᓰᓱᓲᓴᓵᔅᓕᓖᓗ' +
        'ᓘᓚᓛᓪᔨᔩᔪᔫᔭ… ᔮᔾᕕᕖᕗ–—“”‘’ᕘᕙᕚᕝᕆᕇᕈᕉᕋᕌᕐᕿᖀᖁᖂᖃᖄᖅᖏᖐᖑᖒᖓᖔᖕᙱᙲᙳᙴᙵᙶᖖᖠᖡᖢᖣᖤᖥᖦᕼŁł',
    // Python: 'mac_latin2'
    'x-mac-ce': 'ÄĀāÉĄÖÜáąČäčĆćéŹźĎíďĒēĖóėôöõúĚěü†°Ę£§•¶ß®©™ę¨≠ģĮįĪ≤≥īĶ∂∑łĻļĽľĹĺŅ' +
        'ņŃ¬√ńŇ∆«»… ňŐÕőŌ–—“”‘’÷◊ōŔŕŘ‹›řŖŗŠ‚„šŚśÁŤťÍŽžŪÓÔūŮÚůŰűŲųÝýķŻŁżĢˇ',
    // Python: 'mac_roman'
    macintosh: 'ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø' +
        '¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄€‹›ﬁﬂ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ',
    // Python: 'mac_romanian'
    'x-mac-romanian': 'ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ĂȘ∞±≤≥¥µ∂∑∏π∫ªºΩăș' +
        '¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄€‹›Țț‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ',
    // Python: 'mac_turkish'
    'x-mac-turkish': 'ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø' +
...
var getMacEncodingTable = function (encoding) {
    ...
    var encodingTable = {};
    for (var i = 0; i < decodingTable.length; i += 1) {
    ...
    Table.call(this, 'featureListTable', recordList('featureRecord', featureListTable, function (featureRecord, i) {
        ...
        return [
            { name: 'featureTag' + i, type: 'TAG', value: featureRecord.tag },
            {
                name: 'feature' + i,
                type: 'TABLE',
                value: new Table('featureTable', [{ name: 'featureParams', type: 'USHORT', value: feature.featureParams }].concat(ushortList('lookupListIndex', feature.lookupListIndexes))),
            },
        ];
    }));
}
...
function GlyphNames(post) {
    switch (post.version) {
        ...
        case 2:
            ...
            for (var i = 0; i < post.numberOfGlyphs; i += 1) {
...
function makeNameTable(names, ltag) {
    ...
    var nameRecords = [];
    var stringPool = [];
    for (var i = 0; i < nameIDs.length; i += 1) {
        nameID = nameIDs[i];
...
Layout.prototype = {
    ...
    getDefaultScriptName: function () {
        ...
        var hasLatn = false;
        for (var i = 0; i < layout.scripts.length; i += 1) {
    ...
    getFeatureTable: function (script, language, feature, create) {
        ...
        if (langSysTable) {
            ...
            for (var i = 0; i < featIndexes.length; i += 1) {
    ...
    getLookupTables: function (script, language, feature, lookupType, create) {
        ...
        if (featureTable) {
            ...
            for (var i = 0; i < lookupListIndexes.length; i += 1) {
...
Position.prototype.getKerningValue = function (kerningLookups, leftIndex, rightIndex) {
    for (var i = 0; i < kerningLookups.length; i += 1) {
...
Substitution.prototype.addLigature = function (feature, ligature, script, language) {
    ...
    if (pos >= 0) {
        ...
        for (var i = 0; i < ligatureSet.length; i += 1) {
...
execGlyph = function (glyph, prepState) {
    ...
    if (!components) {
        ...
        for (var i = 0; i < components.length; i += 1) {
            ...
            for (var pi = 0; pi < gz.length; pi += 1) {
                var p = gz[pi];
    ...
    for (state.ip = 0; state.ip < pLen; state.ip++) {
        ...
        /*
            if (exports.DEBUG) {
                ...
                if (state.gZone) {
                    da = [];
                    for (let i = 0; i < state.gZone.length; i += 1)
                    {
                        da.push(i + ' ' +
                            state.gZone[i].x * 64 + ' ' +
                            state.gZone[i].y * 64 + ' ' +
                ...
                if (state.tZone) {
                    da = [];
                    for (let i = 0; i < state.tZone.length; i += 1) {
                        da.push(i + ' ' +
                            state.tZone[i].x * 64 + ' ' +
                            state.tZone[i].y * 64 + ' ' +
...
function initTZone(state) {
    ...
    for (var i = 0; i < tZone.length; i += 1) {
...
function MDRP_MIRP(indirect, setRp0, keepD, ro, dt, state) {
    ...
    if (exports.DEBUG) {
        console.log(state.step, (indirect ? 'MIRP[' : 'MDRP[') +
            ...
            ']', indirect ? cvte + '(' + state.cvt[cvte] + ',' + cv + ')' : '', pi, '(d =', od, '->', sign * d, ')');
    }
    state.rp1 = state.rp0;
    state.rp2 = pi;
    if (setRp0) {
...
function lookupCoverageList(coverageList, contextParams) {
    var lookupList = [];
    for (var i = 0; i < coverageList.length; i += 1) {
...
function chainingSubstitutionFormat3(contextParams, subtable) {
    ...
    if (contextRulesMatch) {
        for (var i = 0; i < subtable.lookupRecords.length; i += 1) {
...
function willConnectPrev(charContextParams) {
    ...
    for (var i = backtrack.length - 1; i >= 0; i -= 1) {
...
function willConnectNext(charContextParams) {
    ...
    for (var i = 0; i < charContextParams.lookahead.length; i += 1) {
...
Bidi.prototype.getTextGlyphs = function (text) {
    this.processText(text);
    var indexes = [];
    for (var i = 0; i < this.tokenizer.tokens.length; i += 1) {
...
function makeFvarTable(fvar, names) {
    ...
    for (var i = 0; i < fvar.axes.length; i += 1) {
