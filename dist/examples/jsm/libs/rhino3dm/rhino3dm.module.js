    ...
    return function (rhino3dm) {
        ...
        function addFunctionWasm(func, sig) {
            if (!functionsInTableMap) {
                ...
                for (var i = 0; i < wasmTable.length; i += 1) {
        ...
        var FS = {
            ...
            quit: function () {
                ...
                if (fflush)
                    fflush(0);
                for (var i = 0; i < FS.streams.length; i += 1) {
                ...
                return [
                    {
                        ...
                        toWireType: function (destructors, o) {
                            if (elementsLength !== o.length) {
                                throw new TypeError('Incorrect number of tuple elements for ' +
                                    reg.name +
                                    ': expected=' +
                                    elementsLength +
                                    ', actual=' +
        ...
        function __emval_get_method_caller(argCount, argTypes) {
            ...
            var retType = types[0];
            var signatureName = retType.name +
                '_$' +
                types
                    .slice(1)
                    .map(function (t) {
        ...
        function getEnvStrings() {
            if (!getEnvStrings.strings) {
                var lang = ((typeof navigator === 'object' && navigator.languages && navigator.languages[0]) || 'C').replace('-', '_') +
                    '.UTF-8';
                var env = {
                    USER: 'web_user',
                    LOGNAME: 'web_user',
