...
var k = R((exports, module) => {
    'use strict';
    var __spreadArray = (exports && exports.__spreadArray) ||
        function (t, e) {
            for (var r = 0, n = e.length, i = t.length; r < n; r++, i += 1)
                t[i] = e[r];
            return t;
        };
    ...
    function mapValues(t, e) {
        for (var r = [], n = keys(t), i = 0; i < n.length; i += 1) {
            var a = n[i];
    ...
    function pick(t, e) {
        for (var r = Object.keys(t), n = {}, i = 0; i < r.length; i += 1) {
            var a = r[i], o = t[a];
            e(o) && (n[a] = o);
        }
        return n;
    ...
    function merge(t, e) {
        for (var r = cloneObj(t), n = keys(e), i = 0; i < n.length; i += 1) {
            var a = n[i], o = e[a];
            r[a] = o;
        }
        return r;
    ...
    (function (t, e) {
        ...
        (t.prototype.saveState = function () {
            ...
            (t.prototype.atom = function () {
                ...
                return (u === void 0 && this.isPatternCharacter() && (u = this.patternCharacter()),
                    s(u),
                    (u.loc = this.loc(d)),
...
`) +
	...
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#REGEXP_PARSING for details.`),
                    pe.PRINT_ERROR(re.failedOptimizationPrefixMsg +
                        `
` +
                        ('	Failed parsing: < ' +
                            t.toString() +
        ...
        switch (t.type) {
            ...
            case 'Alternative':
                for (var i = t.value, n = 0; n < i.length; n++) {
                    ...
                    if ((o.type === 'Group' && yr(o) === !1) || (o.type !== 'Group' && s === !1))
                        break;
                }
                break;
            default:
                ...
                (a = h.map(n, function (g) {
                    ...
                    if (h.isRegExp(y)) {
                        ...
                        return b.length === 1 && b !== '^' && b !== '$' && b !== '.' && !y.ignoreCase
                            ...
                            : b.length === 2 &&
                                b[0] === '\\' &&
                                !h.contains(['d', 'D', 's', 'S', 't', 'r', 'n', 't', '0', 'c', 'b', 'B', 'f', 'v', 'w', 'W'], b[1])
                                ? b[1]
                                : e.useSticky
                                    ? gr(y)
                                    : _r(y);
    ...
    function Pn(t) {
        var e = [], r = h.map(t, function (a) {
            return h.reduce(t, function (o, s) {
                return (a.PATTERN.source === s.PATTERN.source &&
                    !h.contains(e, s) &&
        ...
        return (e &&
            h.forEach(o, function (c) {
                ...
                if (f !== !1) {
                    ...
                    h.has(c, 'LINE_BREAKS') ? c.LINE_BREAKS === !0 && (i = !0) : Ye.canMatchCharCode(s, c.PATTERN) && (i = !0);
            }),
            e &&
                !i &&
                n.push({
...
` + i);
                        ...
                        if ((ut !== !1
                            ...
                            if (((s = me.longerAlt), s !== void 0)) {
                                ...
                                (p = null),
                                    fr.isCustom === !0
                                        ? ((g = pr.exec(y, L, Z, xe)),
                                            g !== null ? ((o = g[0]), g.payload !== void 0 && (p = g.payload)) : (o = null))
            ...
            (t.prototype.TRACE_INIT = function (e, r) {
                if (this.traceInitPerf === !0) {
                    ...
                    return (this.traceInitIndent < this.traceInitMaxIdent && s(n + '<-- <' + e + '> time: ' + a + 'ms'),
                        this.traceInitIndent--,
                        o);
                }
                else
...
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
        return (Te.has(t, Un) && (r.CATEGORIES = t[Un]),
...
var ne = R((S) => {
    ...
    var Hn = (function (t) {
        ...
        function e(r) {
            var n = t.call(this, []) || this;
            return ((n.idx = 1),
                G.assign(n, G.pick(r, function (i) {
                    return i !== void 0;
                })),
                n);
        }
    ...
    var Dt = (function () {
        function t(e) {
            (this.idx = 1),
                G.assign(this, G.pick(e, function (r) {
                    return r !== void 0;
                }));
        }
  ...
  ` +
    ...
    Me.defaultGrammarResolverErrorProvider = {
        buildRuleNotFoundError: function (t, e) {
            var r = 'Invalid grammar, reference to a rule which is not defined: ->' +
                e.nonTerminalName +
                `<-
inside top level rule: ->` +
    ...
    Me.defaultGrammarValidatorErrorProvider = {
        buildDuplicateFoundError: function (t, e) {
            ...
            var n = t.name, i = ye.first(e), a = i.idx, o = hi.getProductionDslName(i), s = r(i), c = a > 0, f = '->' +
                o +
                (c ? a : '') +
                '<- ' +
                (s ? 'with argument: ->' + s + '<-' : '') +
...
and Non-Terminal names start with a lower case letter.`;
        ...
        buildAlternationPrefixAmbiguityError: function (t) {
            var e = ye
                ...
                .join(', '), r = t.alternation.idx === 0 ? '' : t.alternation.idx, n = 'Ambiguous alternatives: <' +
...
For Further details.`;
        ...
        buildAlternationAmbiguityError: function (t) {
            var e = ye
                ...
                .join(', '), r = t.alternation.idx === 0 ? '' : t.alternation.idx, n = 'Ambiguous Alternatives Detected: <' +
                t.ambiguityIndices.join(' ,') +
                '> in <OR' +
                r +
                '>' +
...
This could lead to an infinite loop.`;
        ...
        buildEmptyAlternationError: function (t) {
            var e = 'Ambiguous empty alternative: <' +
                (t.emptyChoiceIdx + 1) +
                '>' +
                (' in <OR' +
                    t.alternation.idx +
...
var Tt = R((j) => {
    ...
    var Ei = Gt(), I = k(), Ko = Lr(), O = ne(), Ti = (function (t) {
        ...
        return ((e.prototype.startWalking = function () {
            ...
            return ((this.ruleStack = I.cloneArr(this.path.ruleStack).reverse()),
        ...
        return ((e.prototype.walkMany = function (r, n, i) {
            if (r.idx === this.occurrence) {
                ...
                (this.result.isEndOfRule = a === void 0),
                    a instanceof O.Terminal && ((this.result.token = a.terminalType), (this.result.occurrence = a.idx));
            }
            else
        ...
        for (; r.length < e && i < t.length;) {
            ...
            if (s instanceof O.Option)
                ...
                var c = [
                    ...
                    new O.Repetition({ definition: [new O.Terminal({ terminalType: s.separator })].concat(s.definition) }),
                ];
                return o(c);
            }
    ...
    function Qo(t, e, r, n) {
        var i = 'EXIT_NONE_TERMINAL', a = [i], o = 'EXIT_ALTERNATIVE', s = !1, c = e.length, f = c - n - 1, p = [], l = [];
            ...
            if (!I.isEmpty(v)) {
                ...
                if (_ === i) {
                    ...
                    if (u < c - 1) {
                        ...
                        p.push({ nextTokenType: _.terminalType, nextTokenOccurrence: _.idx, ruleStack: d, occurrenceStack: A }),
                            (s = !0);
                    else
                        throw Error('non exhaustive match');
...
var jr = R((x) => {
    ...
    function _t(t) {
        ...
        else if (r instanceof _e.Alternative ||
    ...
    function xi(t, e) {
        ...
        t.accept(r);
        var n = r.alternations, i = M.reduce(n, function (a, o) {
            return (o.definition.length > 255 &&
                a.push({
    ...
    function ds(t, e, r, n) {
        var i = [], a = B.reduce(t, function (s, c, f) {
            return (e.definition[f].ignoreAmbiguities === !0 ||
        ...
        return (B.forEach(a, function (o) {
            ...
            if (s.ignoreAmbiguities !== !0) {
                var c = o.idx, f = o.path, p = B.findAll(a, function (m) {
                    ...
                    var v = [m.idx + 1, c + 1], u = e.idx === 0 ? '' : e.idx, d = n.buildAlternationPrefixAmbiguityError({
                        topLevelRule: r,
                        alternation: e,
                        ambiguityIndices: v,
                        prefixPath: m.path,
...
var Ui = R((Je) => {
    ...
    function Ts(t) {
        return ((t = Vr.defaults(t, { errMsgProvider: Di.defaultGrammarValidatorErrorProvider })),
            ...
            (t.prototype.tryInRepetitionRecovery = function (e, r, n, i) {
                for (var a = this, o = this.findReSyncTokenType(), s = this.exportLexerState(), c = [], f = !1, p = this.LA(1), l = this.LA(1), m = function () {
                    ...
                    if (this.tokenMatcher(l, i)) {
                        ...
                        this.tokenMatcher(l, o) ? (f = !0) : ((l = this.SKIP_TOKEN()), this.addToResyncTokens(l, c));
...
var Hr = R((Be) => {
    ...
    function Ds(t, e) {
        ...
        return Fs.isUndefined(r) || r.configurable
            ? (Object.defineProperty(t, Xi, { enumerable: !1, configurable: !0, writable: !1, value: e }), !0)
            : !1;
    }
...
var ea = R((Y) => {
    ...
    var ve = k(), At = Hr();
    function $i(t, e) {
        for (var r = ve.keys(t), n = r.length, i = 0; i < n; i += 1)
        ...
        var n = {
            ...
            validateVisitor: function () {
                ...
                if (!ve.isEmpty(i)) {
                    ...
                    throw Error('Errors Detected in CST Visitor <' +
...
var la = R((Jt) => {
    ...
    var q = k(), le = Yt(), er = et(), sa = yt(), rt = Tt(), ua = ce(), Xs = zr(), ca = Ue(), Rt = Xe(), $s = Hr(), Zs = (function () {
        ...
        return ((t.prototype.initRecognizerEngine = function (e, r) {
            if (((this.className = $s.classNameFromInstance(this)),
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
            ...
            (t.prototype.subruleInternalError = function (e, r, n) {
                throw ((er.isRecognitionException(e) &&
...
var Ra = R((nr) => {
    ...
    Object.freeze(ir);
    var Ta = !0, ya = Math.pow(2, nu.BITS_FOR_OCCURRENCE_IDX) - 1, _a = Ea.createToken({ name: 'RECORDING_PHASE_TOKEN', pattern: tu.Lexer.NA });
 ...
 inside top level rule: <` +
    ...
    function au(t, e) {
        var r = this;
        ar(e);
        var n = oe.peek(this.recordingProdStack), i = oe.isArray(t) === !1, a = i === !1 ? t : t.DEF, o = new Pe.Alternation({ definition: [], idx: e, ignoreAmbiguities: i && t.IGNORE_AMBIGUITIES === !0 });
        oe.has(t, 'MAX_LOOKAHEAD') && (o.maxLookahead = t.MAX_LOOKAHEAD);
        var s = oe.some(a, function (c) {
            return oe.isFunction(c.GATE);
        });
        return ((o.hasPredicates = s),
            n.definition.push(o),
    ...
    function ar(t) {
        if (t < 0 || t > ya) {
            var e = new Error('Invalid DSL Method idx value: <' +
                t +
                `>
	` +
