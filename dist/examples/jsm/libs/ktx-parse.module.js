...
exports.write = exports.read = exports.KTX2Transfer = exports.KTX2SupercompressionScheme = exports.KTX2Primaries = exports.KTX2Model = exports.KTX2Flags = exports.KTX2DescriptorType = exports.KTX2Container = exports.KTX2ChannelUASTC = exports.KTX2ChannelETC1S = void 0;
const t = new Uint8Array([0]), e = [171, 75, 84, 88, 32, 50, 48, 187, 13, 10, 26, 10];
var n, i, s, a, r, o, l, f;
exports.KTX2SupercompressionScheme = n;
exports.KTX2DescriptorType = i;
exports.KTX2Model = s;
exports.KTX2Primaries = a;
exports.KTX2Transfer = r;
exports.KTX2Flags = o;
exports.KTX2ChannelETC1S = l;
exports.KTX2ChannelUASTC = f;
!(function (t) {
    (t[(t.NONE = 0)] = 'NONE'), (t[(t.BASISLZ = 1)] = 'BASISLZ'), (t[(t.ZSTD = 2)] = 'ZSTD'), (t[(t.ZLIB = 3)] = 'ZLIB');
})(n || (exports.KTX2SupercompressionScheme = n = {})),
    (function (t) {
        t[(t.BASICFORMAT = 0)] = 'BASICFORMAT';
    })(i || (exports.KTX2DescriptorType = i = {})),
    (function (t) {
        (t[(t.UNSPECIFIED = 0)] = 'UNSPECIFIED'), (t[(t.ETC1S = 163)] = 'ETC1S'), (t[(t.UASTC = 166)] = 'UASTC');
    })(s || (exports.KTX2Model = s = {})),
    (function (t) {
        (t[(t.UNSPECIFIED = 0)] = 'UNSPECIFIED'), (t[(t.SRGB = 1)] = 'SRGB');
    })(a || (exports.KTX2Primaries = a = {})),
    (function (t) {
...
class c {
    ...
    _nextUint64() {
        const t = this._dataView.getUint32(this._offset, this._littleEndian) +
            Math.pow(2, 32) * this._dataView.getUint32(this._offset + 4, this._littleEndian);
...
function g(t) {
    ...
    let i = 0;
    for (const e of t)
        n.set(new Uint8Array(e), i), (i += e.byteLength);
    return n;
}
function p(t) {
...
function y(n, s = {}) {
    ...
    const r = [];
    let o = n.keyValue;
    s.keepWriter || (o = x({}, n.keyValue, { KTXwriter: 'KTX-Parse v0.2.1' }));
    for (const e in o) {
        const n = o[e], i = h(e), s = 'string' == typeof n ? h(n) : n, a = i.byteLength + 1 + s.byteLength + 1, l = a % 4 ? 4 - (a % 4) : 0;
        r.push(g([new Uint32Array([a]), i, t, s, t, new Uint8Array(l).fill(0)]));
    }
    const l = g(r), f = new ArrayBuffer(44), U = new DataView(f);
    ...
    for (let t = 0; t < 8; t++)
        U.setUint8(20 + t, c.bytesPlane[t]);
    for (let t = 0; t < c.samples.length; t++) {
        const e = c.samples[t], n = 28 + 16 * t;
    ...
    const _ = e.length + 68 + 3 * n.levels.length * 8, p = _ + f.byteLength;
    ...
    return (w.setUint32(0, n.vkFormat, !0),
