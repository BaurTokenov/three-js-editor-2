...
exports.Utils = exports.ToggleInput = exports.TitleElement = exports.Tips = exports.TextInput = exports.Styles = exports.StringInput = exports.SliderInput = exports.Serializer = exports.SelectInput = exports.Search = exports.REVISION = exports.PanelNode = exports.ObjectNode = exports.NumberInput = exports.Node = exports.Menu = exports.Loader = exports.LabelElement = exports.Input = exports.Element = exports.DraggableElement = exports.ContextMenu = exports.ColorInput = exports.CircleMenu = exports.Canvas = exports.ButtonInput = void 0;
...
class Element extends Serializer {
    ...
    setEnabledInputs(value) {
        ...
        if (!this.enabledInputs)
            dom.classList.remove('inputs-disable');
        if (!value)
            dom.classList.add('inputs-disable');
    ...
    setStyle(style) {
        const dom = this.dom;
        if (this.style)
            dom.classList.remove(this.style);
        if (style)
    ...
    serialize(data) {
        ...
        if (this.inputLength > 0)
            data.inputLength = this.inputLength;
    ...
    deserialize(data) {
        if (data.inputLength !== undefined)
            this.setInput(data.inputLength);
        if (data.outputLength !== undefined)
            this.setOutput(data.outputLength);
...
class PanelNode extends Node {
    ...
    setAlign(align) {
        if (this.align)
            this.dom.classList.remove(this.align);
...
class ContextMenu extends Menu {
    ...
    show() {
        ...
        if (this.opened) {
            if (offsetX < 0)
                offsetX = -domRect.width;
            if (offsetY < 0)
                offsetY = -domRect.height;
