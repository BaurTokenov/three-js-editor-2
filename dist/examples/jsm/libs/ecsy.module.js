...
exports.enableRemoteDevtools = exports.createType = exports.copyValue = exports.copyJSON = exports.copyCopyable = exports.copyArray = exports.cloneValue = exports.cloneJSON = exports.cloneClonable = exports.cloneArray = exports._Entity = exports.World = exports.Version = exports.Types = exports.TagComponent = exports.SystemStateComponent = exports.System = exports.ObjectPool = exports.Not = exports.Component = void 0;
/**
...
class Query {
    ...
    constructor(Components, manager) {
        ...
        for (var i = 0; i < manager._entities.length; i += 1) {
...
class EntityManager {
     ...
     */
    removeAllEntities() {
        for (var i = this._entities.length - 1; i >= 0; i -= 1) {
    ...
    processDeferredRemoval() {
        ...
        for (let i = 0; i < this.entitiesToRemove.length; i += 1) {
            let entity = this.entitiesToRemove[i];
            let index = this._entities.indexOf(entity);
            this._releaseEntity(entity, index);
        }
        this.entitiesToRemove.length = 0;
        for (let i = 0; i < this.entitiesWithComponentsToRemove.length; i += 1) {
...
class System {
    canExecute() {
        if (this._mandatoryQueries.length === 0)
            return true;
        for (let i = 0; i < this._mandatoryQueries.length; i += 1) {
        ...
        if (this.constructor.queries) {
            for (var queryName in this.constructor.queries) {
                ...
                if (unregisteredComponents.length > 0) {
                    throw new Error(`Tried to create a query '${this.constructor.name}.${queryName}' with unregistered components: [${unregisteredComponents
                        .map((c) => c.getName())
                        .join(', ')}]`);
                }
