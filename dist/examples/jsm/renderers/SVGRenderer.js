...
const Projector_1 = require("../renderers/Projector");
const Projector_2 = require("../renderers/Projector");
const Projector_3 = require("../renderers/Projector");
const Projector_4 = require("../renderers/Projector");
class SVGObject extends three_1.Object3D {
    constructor(node) {
        super();
        this.node = node;
    }
...
class SVGRenderer {
    constructor() {
        ...
        const _this = this, _clipBox = new three_1.Box2(), _elemBox = new three_1.Box2(), _color = new three_1.Color(), _diffuseColor = new three_1.Color(), _ambientLight = new three_1.Color(), _directionalLights = new three_1.Color(), _pointLights = new three_1.Color(), _clearColor = new three_1.Color(), _vector3 = new three_1.Vector3(), // Needed for PointLight
        _centroid = new three_1.Vector3(), _normal = new three_1.Vector3(), _normalViewMatrix = new three_1.Matrix3(), _viewMatrix = new three_1.Matrix4(), _viewProjectionMatrix = new three_1.Matrix4(), _svgPathPool = [], _projector = new Projector_1.Projector(), _svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        ...
        this.render = function (scene, camera) {
            if (camera instanceof three_1.Camera === false) {
            ...
            for (let e = 0, el = _elements.length; e < el; e++) {
                ...
                if (material === undefined || material.opacity === 0)
                    continue;
                _elemBox.makeEmpty();
                if (element instanceof Projector_4.RenderableSprite) {
                    _v1 = element;
                    _v1.x *= _svgWidthHalf;
                    _v1.y *= -_svgHeightHalf;
                    renderSprite(_v1, element, material);
                }
                else if (element instanceof Projector_3.RenderableLine) {
                    _v1 = element.v1;
                    _v2 = element.v2;
                ...
                else if (element instanceof Projector_2.RenderableFace) {
                    _v1 = element.v1;
                    _v2 = element.v2;
                    _v3 = element.v3;
