...
const WebGPUObjects_1 = __importDefault(require("./WebGPUObjects"));
const WebGPUAttributes_1 = __importDefault(require("./WebGPUAttributes"));
const WebGPUGeometries_1 = __importDefault(require("./WebGPUGeometries"));
const WebGPUInfo_1 = __importDefault(require("./WebGPUInfo"));
const WebGPUProperties_1 = __importDefault(require("./WebGPUProperties"));
const WebGPURenderPipelines_1 = __importDefault(require("./WebGPURenderPipelines"));
const WebGPUComputePipelines_1 = __importDefault(require("./WebGPUComputePipelines"));
const WebGPUBindings_1 = __importDefault(require("./WebGPUBindings"));
const WebGPURenderLists_1 = __importDefault(require("./WebGPURenderLists"));
const WebGPURenderStates_1 = __importDefault(require("./WebGPURenderStates"));
const WebGPUTextures_1 = __importDefault(require("./WebGPUTextures"));
const WebGPUBackground_1 = __importDefault(require("./WebGPUBackground"));
const WebGPUNodes_1 = __importDefault(require("./nodes/WebGPUNodes"));
const three_1 = require("three");
console.info('THREE.WebGPURenderer: Modified Matrix4.makePerspective() and Matrix4.makeOrtographic() to work with WebGPU, see https://github.com/mrdoob/three.js/issues/20276.');
three_1.Matrix4.prototype.makePerspective = function (left, right, top, bottom, near, far) {
...
three_1.Matrix4.prototype.makeOrthographic = function (left, right, top, bottom, near, far) {
    const te = this.elements;
...
const _frustum = new three_1.Frustum();
const _projScreenMatrix = new three_1.Matrix4();
const _vector3 = new three_1.Vector3();
class WebGPURenderer {
    constructor(parameters = {}) {
        ...
        this.outputEncoding = three_1.LinearEncoding;
        ...
        this._clearAlpha = 1;
        this._clearColor = new three_1.Color(0x000000);
        this._clearDepth = 1;
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            context.configure({
                device: device,
                format: constants_1.GPUTextureFormat.BGRA8Unorm,
                compositingAlphaMode: 'premultiplied',
            });
            this._adapter = adapter;
            this._device = device;
            this._context = context;
            this._info = new WebGPUInfo_1.default();
            this._properties = new WebGPUProperties_1.default();
            this._attributes = new WebGPUAttributes_1.default(device);
            this._geometries = new WebGPUGeometries_1.default(this._attributes, this._info);
            this._textures = new WebGPUTextures_1.default(device, this._properties, this._info);
            this._objects = new WebGPUObjects_1.default(this._geometries, this._info);
            this._nodes = new WebGPUNodes_1.default(this, this._properties);
            this._computePipelines = new WebGPUComputePipelines_1.default(device, this._nodes);
            this._renderPipelines = new WebGPURenderPipelines_1.default(this, device, parameters.sampleCount, this._nodes);
            this._bindings = this._renderPipelines.bindings = new WebGPUBindings_1.default(device, this._info, this._properties, this._textures, this._renderPipelines, this._computePipelines, this._attributes, this._nodes);
            this._renderLists = new WebGPURenderLists_1.default();
            this._renderStates = new WebGPURenderStates_1.default();
            this._background = new WebGPUBackground_1.default(this);
            //
            this._renderPassDescriptor = {
                ...
                depthStencilAttachment: {
                    view: null,
                    depthStoreOp: constants_1.GPUStoreOp.Store,
                    stencilStoreOp: constants_1.GPUStoreOp.Store,
                },
            };
    ...
    render(scene, camera) {
        ...
        if (opaqueObjects.length > 0)
            this._renderObjects(opaqueObjects, camera, scene, lightsNode, passEncoder);
        if (transparentObjects.length > 0)
            this._renderObjects(transparentObjects, camera, scene, lightsNode, passEncoder);
        // finish render pass
        passEncoder.end();
    ...
    getCurrentColorFormat() {
        ...
        if (renderTarget !== null) {
            ...
            format = constants_1.GPUTextureFormat.BGRA8Unorm; // default context format
        }
        return format;
    }
    getCurrentDepthStencilFormat() {
        ...
        if (renderTarget !== null) {
            ...
            format = constants_1.GPUTextureFormat.Depth24PlusStencil8;
        }
        return format;
    }
    ...
    _renderObjects(renderList, camera, scene, lightsNode, passEncoder) {
        ...
        for (let i = 0, il = renderList.length; i < il; i += 1) {
    ...
    _setupIndexBuffer(index, encoder) {
        ...
        const indexFormat = index.array instanceof Uint16Array ? constants_1.GPUIndexFormat.Uint16 : constants_1.GPUIndexFormat.Uint32;
